  ...
  return (
    <footer className="w-full bg-white relative">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-3">
        ...
        <div className="bg-[#0B5DA7] p-6 lg:p-8 flex items-center gap-4 text-white">
          ...
          <div>
            <span className="italic text-xs block text-white/90 tracking-wide">
              Give us a Call
            </span>
            <a
              href={`tel:${clinicInfo.phones.primary.replace(/\s+/g, '')}`}
              className="font-bold text-lg lg:text-xl text-white hover:underline transition-all block mt-0.5 tracking-tight"
            >
        ...
        <div className="bg-[#E94E9A] p-6 lg:p-8 flex items-center gap-4 text-white">
          <div className="w-12 h-12 rounded-full border border-white/40 flex items-center justify-center shrink-0">
            <img
          ...
          <div>
            ...
            <a
              ...
              className="font-bold text-base lg:text-lg text-white hover:underline transition-all block mt-0.5 tracking-tight break-all"
            >
              {clinicInfo.email}
            </a>
          </div>
        ...
        <div className="bg-[#094b87] p-6 lg:p-8 flex items-center gap-4 text-white">
          <div className="w-12 h-12 rounded-full border border-white/40 flex items-center justify-center shrink-0">
            <img
          ...
          <div>
            ...
            <h5 className="font-bold text-sm lg:text-base text-white block mt-0.5 tracking-tight leading-snug">
      ...
      <div className="w-full bg-[#F9FAFC] border-b border-slate-200">
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 min-h-[360px] lg:min-h-[380px]">
          
          {/* Column 1: About & Clinic Intro with Hospital 3D Illustration */}
          <div className="lg:col-span-4 p-6 sm:p-8 lg:p-10 flex flex-col justify-between bg-white lg:bg-transparent border-b lg:border-b-0 border-slate-200 relative overflow-hidden">
            <div>
              <h4 
                className="text-xl font-bold text-[#222B40] mb-3.5 tracking-tight"
              ...
              <a
                href="#about"
                className="inline-flex items-center gap-1.5 bg-[#0B5DA7] hover:bg-[#094b87] text-white font-bold text-xs uppercase tracking-wider px-6 py-3 rounded shadow-sm hover:shadow transition-all duration-200 w-fit mb-4 cursor-pointer"
              >
            ...
            {/* Hospital Building Illustration cleanly anchored at base */}
            <div className="mt-3 pt-3 w-full flex items-end justify-start">
              <img
          ...
          {/* Column 2: Weekly Consultation Hours */}
          <div className="lg:col-span-4 p-6 sm:p-8 lg:p-10 bg-white flex flex-col justify-center border-b lg:border-b-0 lg:border-x border-slate-200">
            <h4 
              className="text-xl font-bold text-[#222B40] mb-5 tracking-tight"
              style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}
            >
              Our Opening Hours
            </h4>
            <div className="space-y-2.5">
              {openingHours.map((item, idx) => (
                <div
                  key={idx}
                  className="flex justify-between items-center py-2 border-b border-dashed border-slate-200 text-xs sm:text-sm text-slate-600 font-medium"
                >
          ...
          {/* Column 3: Full-Bleed Interactive Google Map */}
          <div className="lg:col-span-4 h-72 lg:h-auto w-full relative min-h-[320px] lg:min-h-[360px]">
            <iframe
              src="https://maps.google.com/maps?q=Mumbai%2C%20Maharashtra&t=&z=14&ie=UTF8&iwloc=&output=embed"
              className="w-full h-full min-h-[320px] lg:min-h-[360px] border-0"
              allowFullScreen
              loading="lazy"
      ...
      <div className="bg-white py-4 sm:py-5 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-10 flex flex-col gap-3.5">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-y-4 gap-x-10 sm:gap-x-16 lg:gap-x-24 pl-1 sm:pl-3 lg:pl-5">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-xs sm:text-sm text-slate-600 font-medium">
              ...
              >
                ...
                <span className="font-semibold text-slate-700 group-hover:text-[#3b5998]">Facebook</span>
              </a>
              ...
              >
                ...
                <span className="font-semibold text-slate-700 group-hover:text-[#E4405F]">Instagram</span>
              </a>
              ...
              >
                ...
                <span className="font-semibold text-slate-700 group-hover:text-[#1da1f2]">Twitter</span>
              </a>
              ...
              >
                ...
                <span className="font-semibold text-slate-700 group-hover:text-[#0077b5]">Linkedin</span>
              </a>
          ...
          {/* Copyright strip down like it was before */}
          <div className="text-center text-xs text-slate-400 pt-2.5 border-t border-slate-100 w-full">
